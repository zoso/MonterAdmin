  ...
  return function (t) {
    ...
    var r = n(2),
      ...
      var c,
        ...
        l = !d && x && void 0 !== x[c], l && c in b || (f = l ? x[c] : n[c], b[c] = p && "function" != typeof x[c] ? n[c] : v && l ? i(f, r) : m && x[c] == f ? function (t) {
    ...
    var r = n(19),
        ...
        m = function m() {
      return this;
    };t.exports = function (t, e, n, b, g, x, w) {
      c(n, e, b);var M,
          S,
          O,
          D = function D(t) {
        if (!p && t in E) return E[t];switch (t) {case y:
            return function () {
              return new n(this, t);
            };case v:
            return function () {
          ...
          A = E[d] || E[h] || g && E[g],
          j = A || D(g),
          C = g ? k ? D("entries") : j : void 0,
          L = "Array" == e ? E.entries || A : A;if (L && (O = f(L.call(new t())), O !== Object.prototype && (l(O, T, !0), r || u(O, d) || a(O, d, m))), k && A && A.name !== v && (_ = !0, j = function j() {
        return A.call(this);
      }), r && !w || !p && !_ && E[d] || a(E, d, j), s[e] = j, s[T] = m, g) if (M = { values: k ? j : D(v), keys: x ? j : D(y), entries: C }, w) for (S in M) {
        S in E || i(E, S, M[S]);
      } else o(o.P + o.F * (p || _), e, M);return M;
    };
  }, function (t, e, n) {
    var r = n(9),
        o = n(35),
    ...
    function r(t) {
      ...
      var t = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZWN]|'[^']*'|'[^']*'/g,
        ...
        if (1 !== arguments.length || "string" !== u(r) || /\d/.test(r) || (s = r, r = void 0), r = r || new Date(), r instanceof Date || (r = new Date(r)), isNaN(r)) throw TypeError("Invalid date");s = String(l.masks[s] || s || l.masks["default"]);var d = s.slice(0, 4);"UTC:" !== d && "GMT:" !== d || (s = s.slice(4), c = !0, "GMT:" === d && (f = !0));var p = c ? "getUTC" : "get",
            ...
            x = r[p + "Seconds"](),
            w = r[p + "Milliseconds"](),
            M = c ? 0 : r.getTimezoneOffset(),
            S = i(r),
            O = a(r),
            D = { d: h, dd: o(h), ddd: l.i18n.dayNames[y], dddd: l.i18n.dayNames[y + 7], m: v + 1, mm: o(v + 1), mmm: l.i18n.monthNames[v], mmmm: l.i18n.monthNames[v + 12], yy: String(m).slice(2), yyyy: m, h: b % 12 || 12, hh: o(b % 12 || 12), H: b, HH: o(b), M: g, MM: o(g), s: x, ss: o(x), l: o(w, 3), L: o(Math.round(w / 10)), t: b < 12 ? "a" : "p", tt: b < 12 ? "am" : "pm", T: b < 12 ? "A" : "P", TT: b < 12 ? "AM" : "PM", Z: f ? "GMT" : c ? "UTC" : (String(r).match(e) || [""]).pop().replace(n, ""), o: (M > 0 ? "-" : "+") + o(100 * Math.floor(Math.abs(M) / 60) + Math.abs(M) % 60, 4), S: ["th", "st", "nd", "rd"][h % 10 > 3 ? 0 : (h % 100 - h % 10 != 10) * h % 10], W: S, N: O };return s.replace(t, function (t) {
    ...
    function r(t) {
      return t && t.__esModule ? t : { "default": t };
        ...
        v = function () {
      function t(e) {
        var n = this;(0, u["default"])(this, t), this.element = e, this.element.setAttribute("data-has-picker", ""), this.locale = this.element.getAttribute("lang") || document.body.getAttribute("lang") || "en", this.format = this.element.getAttribute("date-format") || document.body.getAttribute("date-format") || "yyyy-mm-dd", this.localeText = this.getLocaleText(), (0, i["default"])(this.element, { valueAsDate: { get: function get() {
              return n.element.value ? new Date(Date.parse(n.element.value)) : null;
            }, set: function set(t) {
    ...
    function r(t) {
      ...
      function t() {
        var e = this;if ((0, i["default"])(this, t), window.thePicker) return window.thePicker;this.date = new Date(), this.input = null, this.isOpen = !1, this.container = document.createElement("date-input-polyfill"), this.year = document.createElement("select"), t.createRangeSelect(this.year, 1890, this.date.getFullYear() + 20), this.year.className = "yearSelect", this.year.addEventListener("change", function () {
          ...
          this.input.valueAsDate ? this.date = t.absoluteDate(this.input.valueAsDate) : this.date = new Date(), this.year.value = this.date.getFullYear(), this.month.value = this.date.getMonth(), this.refreshDaysMatrix();
    ...
    var r = n(2),
      ...
      var r = _(R, e);r && delete R[e], E(t, e, n), r && t !== R && E(R, e, r);
    } : E,
        Z = function Z(t) {
      var e = z[t] = S(_j[N]);return e._k = t, e;
    },
        G = U && "symbol" == _typeof(_j.iterator) ? function (t) {
      return "symbol" == (typeof t === "undefined" ? "undefined" : _typeof(t));
    } : function (t) {
      return t instanceof _j;
    },
        K = function K(t, e, n) {
      return t === R && K(J, e, n), g(t), e = w(e, !0), g(n), o(z, e) ? (n.enumerable ? (o(t, P) && t[P][e] && (t[P][e] = !1), n = S(n, { enumerable: M(0, !1) })) : (o(t, P) || E(t, P, M(1, {})), t[P][e] = !0), Y(t, e, n)) : E(t, e, n);
    },
        q = function q(t, e) {
      g(t);for (var n, r = m(e = x(e)), o = 0, i = r.length; i > o;) {
        K(t, n = r[o++], e[n]);
      }return t;
    },
        Q = function Q(t, e) {
      return void 0 === e ? S(t) : q(S(t), e);
        ...
        V = function V(t) {
      var e = H.call(this, t = w(t, !0));return !(this === R && o(z, t) && !o(J, t)) && (!(e || !o(this, t) || !o(z, t) || o(this, P) && this[P][t]) || e);
    },
        X = function X(t, e) {
      if (t = x(t), e = w(e, !0), t !== R || !o(z, e) || o(J, e)) {
        var n = _(t, e);return !n || !o(z, e) || o(t, P) && t[P][e] || (n.enumerable = !0), n;
      }
    },
        $ = function $(t) {
      for (var e, n = A(x(t)), r = [], i = 0; n.length > i;) {
        o(z, e = n[i++]) || e == P || e == s || r.push(e);
      }return r;
    },
        tt = function tt(t) {
      for (var e, n = t === R, r = A(n ? J : x(t)), i = [], a = 0; r.length > a;) {
      ...
      if (this instanceof _j) throw TypeError("Symbol is not a constructor!");var t = d(arguments.length > 0 ? arguments[0] : void 0),
          e = function e(n) {
        this === R && e.call(J, n), o(this, P) && o(this[P], t) && (this[P][t] = !1), Y(this, t, M(1, n));
      };return i && W && Y(R, t, { configurable: !0, set: e }), Z(t);
    }, u(_j[N], "toString", function () {
      return this._k;
    }), D.f = X, T.f = K, n(36).f = O.f = $, n(20).f = V, n(37).f = tt, i && !n(19) && u(R, "propertyIsEnumerable", V, !0), h.f = function (t) {
      return Z(p(t));
    }), a(a.G + a.W + a.F * !U, { Symbol: _j });for (var et = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), nt = 0; et.length > nt;) {
      p(et[nt++]);
    }for (var et = k(p.store), nt = 0; et.length > nt;) {
      y(et[nt++]);
    }a(a.S + a.F * !U, "Symbol", { "for": function _for(t) {
        ...
        W = !1;
      } }), a(a.S + a.F * !U, "Object", { create: Q, defineProperty: K, defineProperties: q, getOwnPropertyDescriptor: X, getOwnPropertyNames: $, getOwnPropertySymbols: tt }), C && a(a.S + a.F * (!U || c(function () {
      var t = _j();return "[null]" != L([t]) || "{}" != L({ a: t }) || "{}" != L(Object(t));
      ...
      } }), _j[N][F] || n(6)(_j[N], F, _j[N].valueOf), f(_j, "Symbol"), f(Math, "Math", !0), f(r.JSON, "JSON", !0);
  }, function (t, e, n) {
    n(26)("asyncIterator");
  }, function (t, e, n) {
    n(26)("observable");
    ...
    function r(t, e) {
      ...
      var n, r, o;if (e.singleton) {
        var i = b++;n = m || (m = u(e)), r = l.bind(null, n, i, !1), o = l.bind(null, n, i, !0);
